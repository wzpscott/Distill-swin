    ...
    distillation=dict(
        layers=[
            [
                ...
                'backbone.layers.0.blocks.1.attn', [96, 128], 3
            ],
            [
                'backbone.layers.1.blocks.1.attn',
                'backbone.layers.1.blocks.1.attn', [192, 256], 3
            ],
            [
            ...
            [
                'backbone.layers.2.blocks.3.attn',
                [
                    'backbone.layers.2.blocks.9.attnbackbone.layers.2.blocks.10.attn',
            ...
            [
                'backbone.layers.2.blocks.4.attn',
                [
                    'backbone.layers.2.blocks.12.attnbackbone.layers.2.blocks.13.attn',
            ...
            [
                'backbone.layers.3.blocks.1.attn',
                'backbone.layers.3.blocks.1.attn', [768, 1024], 3
            ]
        ],
...
work_dir = './ddp_results/distill_ca_attn_useAttn_20k_bs=4_3'
gpu_ids = range(0, 1)
