    ...
    cfg_t=dict(
        ...
        auxiliary_head=dict(
            ...
            loss_decode=dict(
                type='CrossEntropyLoss', use_sigmoid=False, loss_weight=0.4))),
    distillation=dict(
        layers=[], weights_init_strategy='equal', parse_mode='regular'),
...
log_level = 'INFO'
load_from = 'Distill-swin/results/base/iter_8000.pth'
resume_from = 'Distill-swin/results/base/iter_8000.pth'
workflow = [('train', 1)]
